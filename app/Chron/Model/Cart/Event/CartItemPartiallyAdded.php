...
final class CartItemPartiallyAdded extends AbstractDomainEvent
{
    public static function forCart(
        ...
        CartItemQuantity $cartItemExpectedQuantity
    ): self {
        return new self([
            ...
            'cart_expected_quantity' => $cartItemExpectedQuantity->value,
        ]);
    }
    ...
    public function cartItemExpectedQuantity(): CartItemQuantity
    {
        return CartItemQuantity::fromInteger($this->content['cart_item_expected_quantity']);
    }
