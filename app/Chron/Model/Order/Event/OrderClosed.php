...
final class OrderClosed extends AbstractDomainEvent
{
    public static function forCustomer(OrderId $orderId, CustomerId $customerId, OrderStatus $orderStatus, string $reason): self
    {
        return new self([
