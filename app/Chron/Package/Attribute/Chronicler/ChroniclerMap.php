...
use App\Chron\Package\Attribute\Reporter\ReporterQueue;
use App\Chron\Package\Chronicler\Contracts\Chronicler;
use App\Chron\Package\Chronicler\Contracts\ChroniclerDecorator;
...
class ChroniclerMap
{
    ...
    protected function makeEntry(ChroniclerAttribute $attribute): void
    {
        ...
        if ($attribute->chronicler !== PgsqlTransactionalChronicler::class) {
            throw new RuntimeException('Not supported yet. use reference in constructor later');
        }
